...
<header class="nexmoe-nav">
    <div class="navSize">
			<a href="/"><img class="avatar" src="https://gitee.com/Unkaer/blog/raw/master/images/portrait.webp"/></a>
			<div class="nav_menu">
				<ul class="menu_ul">
					<li class="menu_li"><a href="https://unkaer.github.io/" target="_blank">Hexo博客</a></li>
					<li class="menu_li"><a href="http://blog.unkaer.cf/" target="_blank">wordpress博客</a></li>
					<li class="menu_li"><a href="https://drive.google.com/" target="_blank">G drive登陆</a></li>
				</ul>
...
function file(path) {
  ...
  if ("|mp4|webm|mkv|flv|wmv|".indexOf(`|${ext}|`) >= 0) {
...
<div class="mdui-container-fluid">
	<br>
	<audio preload="auto" controls="" src="${url}" style="outline: none; width: 100%;"></audio>
	<br>
	<div class="mdui-textfield">
	  <label class="mdui-textfield-label">下载地址</label>
	  <input class="mdui-textfield-input" type="text" value="${url}"/>
	...
	<div class="mdui-textfield">
	  <label class="mdui-textfield-label">HTML 引用地址</label>
	  <input class="mdui-textfield-input" type="text" value='<audio preload="auto" controls="" src="${url}" style="outline: none; width: 100%;"></audio>'/>
	</div>
        <br>
</div>
<a href="${url}" class="mdui-fab mdui-fab-fixed mdui-ripple mdui-color-theme-accent"><i class="mdui-icon material-icons">file_download</i></a>
